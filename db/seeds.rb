...
# @user1 = User.create!(username: 'nicolas', email: 'angle@police.officer', admin: true, password: 'Y0urmonkey!')
# @user2 = User.create!(username: 'frank', email: 'wild@west.nut', admin: false, password: 'Hesnotfromher3!')
# @user3 = User.create!(username: 'theandys', email: 'up@hill.battle', admin: false, password: 'W@nk3r!!!')
# @user4 = User.create!(username: 'janine', email: 'you@never.switchoff', admin: false, password: 'N0td@tingbob')

# puts "#{User.count} users created."

# @location1 = Location.create!(name: 'Minnesota State Fair', city: 'St. Paul', img_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Fairchild.JPG/2560px-Fairchild.JPG', description: 'The Minnesota State Fair is the state fair of the U.S. state of Minnesota. Also known by its slogan, "The Great Minnesota Get-Together", it is the largest state fair in the United States by average daily attendance.')
# @location2 = Location.create!(name: 'Target Field', city: 'Minneapolis', img_url: 'https://www.gannett-cdn.com/-mm-/760fdfdecace851ee9099a13434838ed133f7d9c/c=0-140-2000-1268/local/-/media/SiouxFalls/mattzimmer/2014/04/30//1398836646000-TargetField.jpg', description: 'Stuff happens here')
# @location3 = Location.create!(name: 'Disney Land', city: 'Somewhere in Cali', img_url: 'https://cdn1.parksmedia.wdprapps.disney.com/media/blog/wp-content/uploads/2021/04/p2o8y7gu313-1024x683.jpg', description: 'Stuff happens here')
# @location4 = Location.create!(name: 'Disney World', city: 'The one in Florida', img_url: 'https://images.indianexpress.com/2021/06/Walt-Disney-World_1200.jpg', description: 'Stuff happens here')
# @location5 = Location.create!(name: 'Taste of Chicago', city: 'Chicago', img_url: 'https://viewfinder.expedia.com/wp-content/uploads/2020/02/Taste-of-Chicago-Entrance-Sign-Header-Image.jpg', description: 'Stuff happens here')
# @location6 = Location.create!(name: 'Jurassic Park', city: 'Isla Nublar', img_url: 'https://cdna.artstation.com/p/assets/images/images/010/393/256/large/mat-jolicoeur-12-1920.jpg?1524172062', description: 'Stuff happens here')
# @location7 = Location.create!(name: 'Hogsmeade', city: 'Secret Location', img_url: 'https://wallpaperaccess.com/full/1894037.jpg', description: 'Stuff happens here')
...
# 72.times do
#     Food.create!(name: Faker::Food.dish, cuisine: cuisine.sample, description: Faker::Food.description, food_stall: Faker::Movies::HarryPotter.location, img_url: images.sample , rating: rand(0..10), location_id: rand(1..9), user_id: rand(1..4))
# end
